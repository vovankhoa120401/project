...
if (empty($_SESSION['user']['userName'])) {
    ...
    header("Location: $config/admin/user/view/login-register.php");
    exit;
} else {
            ...
            <div class="nav-right ">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="<?php echo  $config['baseUrl'] ?>/admin/user/view/login-register.php">Thoát</a>
                    </div>
                </div>
            </div>
        </nav>
